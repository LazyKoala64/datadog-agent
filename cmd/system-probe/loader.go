...
// Loader is responsible for managing the lifecyle of each api.Module.
// The main responsibilites are:
// * Module initialization;
// * Module termination;
// * Providing a consolidate view of each Module status/telemetry;
type Loader struct {
